var size = 0;
var placement = 'point';
function categories_Reservatorios_1(feature, value, size, resolution, labelText,
...
var style_Reservatorios_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("Categoria");
        if ("" !== null) {
            labelText = String("");
        }
    ...
    var style = categories_Reservatorios_1(feature, value, size, resolution, labelText,
